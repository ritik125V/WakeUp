        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 sm:gap-4 border-b border-neutral-900 pb-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-purple-950/80 hover:bg-purple-900 text-purple-200 text-xs font-bold rounded-lg border border-purple-500/30 transition-all cursor-pointer shadow-md"
            >
